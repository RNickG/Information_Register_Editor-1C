...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлементСписокРС.УстановитьДействие("Выбор", "ДинамическийСписокРСВыбор");
...
&НаКлиенте
Процедура ДинамическийСписокРСВыбор(ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
Процедура ИницализироватьРеквизитыЭлементыФормы()
	...
	Для Каждого Ресурс из Метаданные.РегистрыСведений[ИмяРегистраСведений].Ресурсы Цикл
		...
		Иначе
			ПоляЗапроса = ПоляЗапроса + """<Хранилище>"" КАК " + Ресурс.Имя + ","+Символы.ПС;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Реквизит из Метаданные.РегистрыСведений[ИмяРегистраСведений].Реквизиты Цикл
		...
		Иначе
			ПоляЗапроса = ПоляЗапроса + """<Хранилище>"" КАК " + Реквизит.Имя + ","+Символы.ПС;
		КонецЕсли;
	КонецЦикла;
	...
	СтруктураРеквизитов.Вставить("Измерения", Новый Массив);
	...
	Для Каждого Измерение из Метаданные.РегистрыСведений[ИмяРегистраСведений].Измерения Цикл
		ДобавитьРеквизитФормыСвойство(Измерение, Элементы["ГруппаИзмерения"]);
		СтруктураРеквизитов.Измерения.Добавить(Измерение.Имя);
	КонецЦикла;
	...
	Для Каждого Реквизит из Метаданные.РегистрыСведений[ИмяРегистраСведений].Реквизиты Цикл
		...
		ДобавитьРеквизитФормыСвойство(Реквизит, Элементы["ГруппаРеквизиты"], Реквизит.Тип.СодержитТип(Тип("ХранилищеЗначения")));
	КонецЦикла;
